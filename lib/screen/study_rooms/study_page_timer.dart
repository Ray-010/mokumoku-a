...
class StudyPageTimer extends StatelessWidget {
  ...
  StudyPageTimer(this.roomDocumentId, this.uid, this.color, this.imageIndex, this.progressMessage);
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                        border: Border(bottom: BorderSide(
                          color: model.started ? Colors.grey : Colors.black54,
                    ...
                    child: Text(
                      model.timeToDisplay,
                      style: TextStyle(
                        color: model.started ? Colors.grey : Colors.black87,
                        fontSize: 36,
